...
#This is a base class (parent) that provides a template for specific data loaders.
...
class DataLoaderPintos(DataLoader):
    #progs: List of CSV files (real disk logs).
    #boot=False: If True, includes all data; otherwise, filters only executed requests.
    def __init__(self, progs, boot=False):
        ...
        for prog in progs:
            ...
            #filtering only the executed requests.
